...
When you use SaveMyAttachments, we may access:
...
SaveMyAttachments uses OpenRouter for AI processing. When you use AI features:

- Email content is sent directly to OpenRouter using your personal API key
- OpenRouter's privacy policy applies to this data: [https://openrouter.ai/privacy](https://openrouter.ai/privacy)
- You control which AI model processes your data
- No email content is stored on our servers during this process
...
Google's Privacy Policy applies to these services: [https://policies.google.com/privacy](https://policies.google.com/privacy)

## Data Retention

- **Processing Logs**: Minimal logs retained for 30 days for debugging purposes
- **User Accounts**: Account information retained while you use our services
- **Email Tracking**: Email IDs tracked locally in your Google environment to prevent duplicate processing
