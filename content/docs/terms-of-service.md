...
Additional products and services may be added over time.

## 3. Account Registration

### 3.1 Eligibility

You must be at least 13 years old to use our Services. By using our Services, you represent that you meet this age requirement.
...
Some Services require third-party API keys (e.g., OpenRouter):
- You are responsible for obtaining and managing your API keys
- You agree to comply with third-party terms of service
- You are responsible for costs incurred with third-party services
- We are not liable for third-party service interruptions or issues

## 4. Subscription and Payments

### 4.1 Pricing

Services are available through subscription plans available on the Google Workspace Marketplace. Pricing is displayed before purchase.

### 4.2 Billing

- Subscriptions are billed according to the plan you select (monthly or annually)
- Payment processing is handled by Google Workspace Marketplace
- Prices are subject to change with 30 days notice
- You are responsible for any additional costs (e.g., OpenRouter API usage)
...
You may cancel your subscription at any time through the Google Workspace Marketplace. Cancellation takes effect at the end of the current billing period.
...
- Use Services in any way that could harm, disable, or impair our infrastructure

### 5.2 Data Processing

By using our Services, you authorize us to:
- Access your Gmail emails for processing as configured
- Save files to your Google Drive
- Create and update Google Sheets
- Send email content to OpenRouter (using your API key) for AI processing
...
- The content of emails you process
- Compliance with applicable laws regarding data processing
- Any consequences resulting from processing emails containing sensitive or confidential information
...
We grant you a limited, non-exclusive, non-transferable license to use our Services according to these Terms during your subscription period.

## 7. Privacy and Data Protection

Your privacy is important to us. Please review our [Privacy Policy](/docs/privacy-policy.html) to understand how we collect, use, and protect your information.

Key points:
- We do not store your email content on our servers
- Your data remains in your Google Workspace environment
- AI processing uses your personal OpenRouter API key
...
We strive to maintain high availability but do not guarantee uninterrupted access. Services may be unavailable due to:
- Scheduled maintenance
- Technical issues
- Third-party service dependencies (Google Workspace, OpenRouter)
...
- OpenRouter service availability, costs, or accuracy
- Google Workspace service interruptions
- Third-party API changes or deprecations
- Data loss due to third-party service issues
...
- Your data or content processed through our Services

## 11. Termination

### 11.1 By You

You may terminate your account at any time by canceling your subscription through the Google Workspace Marketplace.
...
- Data stored in your Google Workspace environment remains yours
- No refunds for partial billing periods (unless required by law)
- These Terms will continue to apply to past use of Services
...
Any disputes arising from these Terms or use of Services shall be resolved through binding arbitration, except where prohibited by law.
...
We may modify these Terms at any time. Continued use of Services after changes constitutes acceptance of the modified Terms. We will notify you of material changes via email or in-app notification.
...
If you obtained our Services through the Google Workspace Marketplace:
- Google's terms and policies also apply
- Billing is handled by Google
- Refunds follow Google's policies
- Some features may be subject to Google's API limitations

## 15. Beta Features

We may offer beta features marked as "experimental" or "beta":
- These features are provided as-is without warranty
- They may be discontinued at any time
- They may contain bugs or errors
